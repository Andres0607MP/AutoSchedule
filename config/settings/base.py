...
MIDDLEWARE = [
    ...
    'config.middleware.AuthorizationHeaderMiddleware',
...
# Static files (collected by `collectstatic`) will be placed here
STATIC_ROOT = BASE_DIR / 'staticfiles'

# Use WhiteNoise storage to serve compressed static files in production
...
# SimpleJWT recommended settings
